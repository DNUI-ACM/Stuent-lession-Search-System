...
// 创建 accout 表
    //query->exec( "create table accout(index_of_student varchar(12) PRIMARY KEY not null,  password_of_student varchar(50) not null)");
    //query->exec( "insert into accout(index_of_student, password_of_student) values('17180600301', md5(123))");//插入用户信息
    //query->exec( "insert into accout(index_of_student, password_of_student) values('17180600302', md5(123))");//插入用户信息
    //query->exec( "insert into accout(index_of_student, password_of_student) values('17180600303', md5(123))");//插入用户信息
    //query->exec( "insert into accout(index_of_student, password_of_student) values('17180600304', md5(123))");//插入用户信息
...
//le//ssion
    //query->exec("create table lession (index_of_lession varchar(4) PRIMARY KEY not null,  name_of_lession varchar(50) not null)");
//插//入课程信息 lession
    ...
    ////teacher
    //query->exec("create table teacher (index_of_teacher varchar(10) PRIMARY KEY not null,  name_of_teacher varchar(10) not null)");
    ...
    ////school
    //query->exec("create table school(index_of_school varchar(10) PRIMARY KEY not null,  name_of_school varchar(10) not null)");
    //query->exec("insert into school(index_of_school, name_of_school) values('0', '大连东软信息学院' )" );
    //qWarning() << query->lastError() <<endl;

    ////information_of_student
    //query->exec("create table information_of_student(index_of_student varchar(12) PRIMARY KEY not null, name_of_student varchar(10) not null, index_of_class varchar(6)  not null, sex varchar(1)  not null)");
    ...
    ////department
    //query->exec("create table department(index_of_department varchar(2) PRIMARY KEY not null, name_of_department varchar(10) not null, index_of_school varchar(10)  not null)");
